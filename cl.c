...
#endif
{
  ...
  {
  {
    ...
    if ( (LA(1)==PROCEDURE) ) {
      ...
      proc_code(zzSTR); zzlink(_root, &_sibling, &_tail);
      dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
      ...
      if ( (LA(1)==FUNCTION) ) {
        ...
        func_code(zzSTR); zzlink(_root, &_sibling, &_tail);
        dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  {
  if ( (LA(1)==WHILE) ) {
    whiledo(zzSTR); zzlink(_root, &_sibling, &_tail);
  }
  else {
    if ( (LA(1)==IF) ) {
      ifthenelse(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (LA(1)==IDENT) ) {
        zzmatch(IDENT); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
          ...
          if ( (setwd3[LA(1)]&0x10) ) {
            {
              ...
              for (;;) {
                ...
                if ( (LA(1)==DOT) ) {
                  ...
                  if ( (LA(1)==OPENKEY) ) {
                    zzmatch(OPENKEY); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
                    expression(zzSTR); zzlink(_root, &_sibling, &_tail);
                    zzmatch(CLOSEKEY);  zzCONSUME;
                  }
            ...
            if ( (LA(1)==OPENPAR) ) {
              ...
              l_values(zzSTR); zzlink(_root, &_sibling, &_tail);
              zzmatch(CLOSEPAR);  zzCONSUME;
            }
        ...
        if ( (setwd3[LA(1)]&0x40) ) {
          ...
          if ( (LA(1)==READ) ) {
            ...
            if ( (LA(1)==OPENANGL) ) {
              zzmatch(OPENANGL); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
              l_values(zzSTR); zzlink(_root, &_sibling, &_tail);
              zzmatch(CLOSEANGL);  zzCONSUME;
              zzmatch(ASIG); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
              expression(zzSTR); zzlink(_root, &_sibling, &_tail);
            }
...
#endif
{
  ...
  if ( (LA(1)==NOT) ) {
    ...
    if ( (LA(1)==MINUS) ) {
      ...
      if ( (setwd5[LA(1)]&0x8) ) {
        expression5(zzSTR); zzlink(_root, &_sibling, &_tail);
      }
...
#endif
{
  ...
  if ( (LA(1)==IDENT) ) {
    ...
    if ( (LA(1)==INTCONST) ) {
      ...
      if ( (LA(1)==CIERTO) ) {
        zzmatch(CIERTO); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
      }
      else {
        if ( (LA(1)==FALSO) ) {
          zzmatch(FALSO); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
        }
        else {
          if ( (LA(1)==OPENANGL) ) {
            zzmatch(OPENANGL); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
